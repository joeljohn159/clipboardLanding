    ...
    return (
        <section id="supercharge">
                <div className="section-container px-10 my-20">
                    ...
                    The work landscape is undergoing a seismic shift, and artificial intelligence (AI) stands at the forefront of this transformation. No longer confined to science fiction, AI is rapidly infiltrating our daily routines, empowering us to achieve more with less effort.   
                    </p>

                    <div className="flex flex-col items-center justify-between space-y-16 md:flex-row md:space-y-0 md:space-x-12">
                        {/* Item 1 */}
                        <div className="flex flex-col items-center space-y-5">
                        <svg className="mb-6" width="44" height="40" xmlns="http://www.w3.org/2000/svg"><g fill="#9EABB2" fill-rule="nonzero"><path d="M11.07 0C8.353 0 6.14 2.192 6.14 4.876l-.179 25.278 2.69.02.179-25.289c0-1.21 1.005-2.196 2.24-2.196h27.027V0H11.071z"/><path d="M38.097 0a5.115 5.115 0 00-5.11 5.11v28.37c0 2.052-1.668 3.72-3.72 3.72a3.725 3.725 0 01-3.72-3.72V30.21c0-.743-.601-1.345-1.344-1.345H1.345C.602 28.864 0 29.466 0 30.21v3.272a6.417 6.417 0 006.41 6.409V37.2a3.724 3.724 0 01-3.72-3.72v-1.927h20.168v1.928a6.417 6.417 0 006.41 6.409 6.417 6.417 0 006.409-6.41V12.46h6.185c.743 0 1.345-.602 1.345-1.345V5.11A5.115 5.115 0 0038.097 0zm2.42 9.77h-4.84V5.11a2.423 2.423 0 012.42-2.42 2.423 2.423 0 012.42 2.42v4.66z"/><path d="M6.14 37.201h22.813v2.689H6.14zM19.99 7.485h-6.947a1.345 1.345 0 100 2.69h6.947a1.345 1.345 0 100-2.69zM28.057 12.863H13.043a1.345 1.345 0 100 2.69h15.014a1.345 1.345 0 100-2.69zM28.057 18.242H13.043a1.345 1.345 0 100 2.69h15.014a1.344 1.344 0 100-2.69zM28.057 23.62H13.043a1.345 1.345 0 100 2.69h15.014a1.345 1.345 0 100-2.69z"/></g></svg>
                        <h5 className="mb-2 text-2xl font-bold text-darkGrayishBlue">Create Blacklists</h5>
                        <p className="max-w-md text-grayishBlue">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur, hic?</p>
                        ...
                        <h5 className="mb-2 text-2xl font-bold text-darkGrayishBlue">Plain text Snippet</h5>
                        <p className="max-w-md text-grayishBlue">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur, hic?</p>
                        ...
                        {/* Item 3 */}
                        <div className="flex flex-col items-center space-y-5">
                        <svg className="mb-6" width="36" height="32" xmlns="http://www.w3.org/2000/svg"><path d="M17.872 14.736a235.39 235.39 0 012.192 5.744c.746 2.027 1.536 4.24 2.368 6.64h-5.344a44.4 44.4 0 00-.784-2.368c-.288-.81-.57-1.632-.848-2.432h-8.64c-.278.8-.56 1.621-.848 2.432a44.4 44.4 0 00-.784 2.368H0a371.54 371.54 0 012.368-6.644 233.104 233.104 0 012.192-5.748 206.71 206.71 0 012.112-5.112c.693-1.61 1.413-3.136 2.16-4.736H13.6c.725 1.6 1.44 3.125 2.144 4.736.704 1.61 1.413 3.328 2.128 5.12zM7.968 18.32h6.303c-.34-.96-.671-1.878-.991-2.752a94.407 94.407 0 00-.912-2.4c-.288-.725-.539-1.365-.752-1.92-.214-.555-.384-.992-.512-1.313-.107.32-.267.758-.48 1.313a1241.872 1241.872 0 00-1.648 4.32c-.331.874-.667 1.792-1.008 2.752zM35.04 3.2h-3.2v25.6h3.2V32h-9.6v-3.2h3.2V3.2h-3.2V0h9.6v3.2z" fill="#9EABB2" fill-rule="nonzero"/></svg>
                        <h5 className="mb-2 text-2xl font-bold text-darkGrayishBlue">Sneak Preview</h5>
                        <p className="max-w-md text-grayishBlue">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tenetur, hic?</p>
